...
setkey(censor.dt, run_id, sample_id, login_day, login_time, logout_day, logout_time, user_id, location_id)
save(censor.dt, breakoutDays, file = "../input/censored.Rdata")
```
