...
% define Scala
\lstdefinelanguage{scala}{morekeywords={class,object,trait,extends,with,new,if,while,for,def,val,var,this,case,->,=>},
%otherkeywords={->,=>},
%procnamekeys={def,.},
sensitive=true,
